			...
			<view class="register-form">
				<u-form class="uview_from" ref="uForm">
					...
					<u-form-item class="auth_code_style" :border-bottom="true" label-width="0">
						...
						<u-button hover-class="none" shape="circle" slot="right" :custom-style="codeBtnStyle" type="default" @click="sendCode" :disabled="smsFlag">
							{{ sendTime }}
						</u-button>
					</u-form-item>
...
export default {
	...
	methods: {
		...
		loginClick() {
			...
			// register
			// sendsms
			this.$api.register(postObj).then(res => {
				console.log('res', res);
				if (res.data.event == 100) {
